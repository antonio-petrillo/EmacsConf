...
(setq selected-theme 'doom-old-hope)

(setq selected-font "JetBrainsMono")
...
(use-package evil
  ...
  (setq undo-limit (* 100 (* 1024 1024))) ;; 100 Mb see, https://tecosaur.github.io/emacs-config/config.html#better-defaults
...
**** Python lang
For occasional scripting, ps I hate python!!!
#+begin_src emacs-lisp :tangle "lisp/init-prog.el" :mkdirp yes
